<x-modal wire:model="showExpenseTypeDeleteModal" size="md">
    @isset($expenseType)
        <x-slot name="modalHeader">
            <h1 class="text-2xl font-semibold">
                Delete {{ $expenseType->expense_type_name }}
            </h1>
        </x-slot>

        <div class="text-gray-700">
            <p class="text-base font-semibold">
                Are you sure you want to delete {{ $expenseType->expense_type_name }}?
            </p>
