<x-page-layout>
    ...
    <x-content-header-section>
        <div class="flex space-x-5 items-center">
            ...
            @can('delete role')
                <button type="button"
                        wire:click="$emit('deleteRole', {{ $selectedRole }})"
                        class="inline-flex justify-center rounded-md border border-red-300 bg-red-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
    ...
    <div class="max-w-6xl">
        <div class="bg-white py-6 grid grid-cols-5 gap-x-5 gap-y-8">
