<div x-data="{
    ...
    <div
        ...
        <div class=" flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
            <div
                 @class([
                     'relative bg-white rounded-lg text-left shadow-xl transform transition-all sm:my-8 w-full',
                     'max-w-md' => $size == 'sm',
                     'max-w-xl' => $size == 'md',
                     'max-w-2xl' => $size == 'md2',
                     'max-w-4xl' => $size == 'lg',
                ...
                <div class="bg-white  sm:rounded-lg" x-trap.noscroll="show">

                    <div class="bg-primary flex items-center justify-between px-6 py-4 text-white rounded-t-lg">
                        @isset($modalHeader)
                            {{ $modalHeader }}
                        @endisset
                    ...
                    <div class="py-3 bg-gray-200 rounded-b-lg px-6 flex justify-between">
                        <div>
